    ...
    <div class="card p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        <div class="max-w-sm rounded">
            ...
            <form action="{{ Route('post.like') }}" method="POST" class=" space-y-2 float-right">
                ...
                <button>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 inline-block pb-1 text-red-500 hover:text-red-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <form action="{{ Route('post.like') }}" method="POST" class=" space-y-2 float-right">
                ...
                <input hidden id="like" name="like" type="number" value="1">
                <button>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 inline-block pb-1 text-gray-300 hover:text-red-500" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" />
                    </svg>
                </button>
            </form>
