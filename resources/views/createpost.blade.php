    ...
    @section('content')
    <div class="container pt-36 font-normal px-2 mb-48">
        <div class="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl text-center">
            New Blog Post
        </div>
        <div
                ...
                <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col space-y-3 sm:w-72 mx-1">
                        ...
                        <div aria-label="File Upload Modal" class="relative h-full flex flex-col"
                            ...
                            <div
                                class="border-dashed border-2 border-gray-200 py-12 flex flex-col justify-center items-center rounded-md">
                        ...
                        <div class="mt-5 text-right ">
                            <button type="submit"
                                class="h-10 w-full bg-primary rounded text-white hover:bg-primarydark">Post</button>
                        </div>
                    </div>
                </form>
                <!-- Image Preview -->
                <div class="flex flex-col sm:w-72 mx-1 mt-5 sm:mt-0">
                    <h1 class="pb-3 text-base sm:text-lg text-gray-900 text-center">
                        Image Preview
                    </h1>
...
document.getElementById("cancel").onclick = () => {
    ...
    FILES = {};
    empty.classList.remove("hidden-input");
